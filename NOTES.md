- Add category field(drop down) and content field to users show page List of cureent items should also be n users page. with edit and delete button next to each item.
